...
class SproutGigs():
	...
	def Define_Data(self):
		self.website_name = "SproutGigs"
		self.website_link = "https://{}.com/jobs.php".format(self.website_name.lower())
		...
		self.category_link_template = self.website_link + "?&category={}&sub_category="

	def Open_Website(self, category_name, category_number, first_space, second_space = False):
		if first_space == True:
			print()

		print(Language_Item_Definer("Opening", "Abrindo") + " " + self.website_name + " " + Language_Item_Definer('on "{}" category to work', 'na categoria "{}" para trabalhar').format(category_name) + "...")

		Open_Link(self.category_link_template.format(category_number))
	...
	def Help_With_Jobs(self):
		...
		while self.finish_working == False:
			...
			if self.chosen_list == None:
				...
				self.Open_Website(self.category_name, self.category_number, True)
			...
			if self.choice == Language_Item_Definer("Change website", "Mudar site"):
				...
				self.Open_Website(self.category_name, self.category_number, False, True)
			...
			if self.choice == Language_Item_Definer("Finish working", "Terminar de trabalhar"):
				...
				Write_On_Diary_Slim_Module("Trabalhei um pouco no " + self.website_name)
