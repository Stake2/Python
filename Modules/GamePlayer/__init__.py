	...
	def __init__(self):
		...
		if hasattr(self, "arguments") == True:
			...
			if has_active_arguments == True:
				...
				selected_class = self.arguments["Active argument"]["Auto-class"]

				# Import the module of the class
				module = importlib.import_module("." + selected_class, self.__module__)

				# Get the class of the module and create its dictionary
				selected_class = {
					"Object": getattr(module, selected_class)
				}
